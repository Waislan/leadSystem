        ...
        <div class="row">
            <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">Informe os dados do colaborador</div>
                    <div class="panel-body">
                        <form id="formCadastro" class="text-center border border-light p-5">
                            ...
                            <div class="form-row mb-4">
                                ...
                                <div class="col">
                                    <input type="text" id="inputCpf" name="inputCpf" class="form-control" placeholder="CPF" required>
                                    <small id="alertCpfInvalido" class="form-text text-muted mb-4" hidden>
                            ...
                            -->
                            <div>
                                <input type="checkbox" class="form-check-input" id="permissoesAdmin">
                                <label for="permissoesAdmin">Conceder permissões de administrador</label>
                            </div>
                            ...
                            <div class="row" >
                                <a href="gerenciar-colaboradores.php" style="color: black;">Voltar</a>
                            </div>
                            <hr>
                            <!--
                            <p>Clicando em
